    ...
    <>
      ...
      <section className="px-6 py-14 text-center">
        ...
        <p className="text-charcoal/70 leading-relaxed max-w-xl mx-auto">
          Based in Richland, WA and serving outdoor weddings {BUSINESS_INFO.serviceRadiusNote} —
          including Kennewick, Pasco, Benton City, Prosser, Walla Walla, and Spokane.
        </p>
      </section>
